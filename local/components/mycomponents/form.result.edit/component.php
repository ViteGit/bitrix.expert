    ...
    if (strlen($arResult["ERROR"]) <= 0)
    {
      ...
      //      debug( $arResult["arrVALUES"]);
            ...
            )
            {
                ...
                {
                    $return = false;
                    if (CFormResult::SetStatus($arParams["RESULT_ID"], $arResult["arrVALUES"]["status_SIMPLE_FORM_1"]))
                    {
...
//                            if ($arResult["arrVALUES"]["status_SIMPLE_FORM_1"] == 4){
                                CFormResult::SetField($arResult["arrVALUES"]["index_php?RESULT_ID"], 'comment', $arResult["arrVALUES"]["form_textarea_ADDITIONAL_5"]);
//                            }
                ...
                foreach ($arResult["arAnswers"][$FIELD_SID] as $key => $arAnswer)
                {
                    ...
                    switch ($arAnswer["FIELD_TYPE"])
                    {
                        ...
                        case "text":
                            ...
                            $arResult["QUESTIONS"][$FIELD_SID]["HTML_CODE"][] = $res;
                            $arResult["QUESTIONS"][$FIELD_SID]["VALUES"][] = $value;
